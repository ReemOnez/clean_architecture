...
abstract class $ToDoModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, int userId, String todo});
}
...
class _$ToDoModelImpl implements _ToDoModel {
  const _$ToDoModelImpl(
      {required this.id, required this.userId, required this.todo});
  ...
  @override
  String toString() {
    return 'ToDoModel(id: $id, userId: $userId, todo: $todo)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, userId, todo);
...
abstract class _ToDoModel implements ToDoModel {
  const factory _ToDoModel(
      ...
      required final String todo}) = _$ToDoModelImpl;
